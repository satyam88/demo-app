pipeline {
    ...
    environment {
        ...
        NEXUS_IMAGE_NAME = "35.154.26.130:8085/demo-application:dev-demo-application-v.1.${env.BUILD_NUMBER}"
    }
            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'nexus-credentials', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]) {
                        sh 'docker login http://35.154.26.130:8085/repository/demo-application/ -u admin -p ${PASSWORD}'
